...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark" style="font-size: 15px">
    <a class="navbar-brand" href="<c:url value="/"/>" style="margin-bottom: 10px"><b>TakeCareOfUs</b></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/#"><b>#1</b></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/#"><b>#2</b></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="#"><b>#3</b></a>
            </li>
        ...
        <div class="navbar-nav ml-auto mb-auto">
            ...
            <c:if test="${empty sessionScope.user == false}">
                <c:if test="${sessionScope.userType == 'ВЕТЕРИНАР'}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/calendar"><b>Мій календар</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/request/vet"><b>Запити користувачів</b></a>
                    </li>
                    <li class="nav-item">
                ...
                <c:if test="${sessionScope.userType == 'ВЛАСНИК'}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/request"><b>Мої записи</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/logout"><b>Вийти</b></a>
                    </li>
