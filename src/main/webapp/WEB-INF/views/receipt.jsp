...
<head>
    ...
    <link href="<c:url value="../../resources/css/login.css"/>" rel="stylesheet" type="text/css"></head>
<body>
    ...
    <div class="container-fluid h-custom">
        <div class="row d-flex justify-content-center align-items-center h-100">
            ...
            <div style="margin-top: 5rem" class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                ...
                <form method="POST" action="${pageContext.request.contextPath}/receipt" autocomplete="off">
                    <div class="form-outline mb-4">
                        <label for="vetFullName">ПІБ Лікаря
                            <input type="text" id="vetFullName" name="vetFullName" class="form-control form-control-lg" required/>
                        </label>
                    </div>
                    <div class="form-outline mb-4">
                        <label for="clinicName">Введіть назву клініки
                            <input type="text" id="clinicName" name="clinicName" class="form-control form-control-lg" required/>
                        </label>
                    </div>
                    <div class="form-outline mb-4">
                        <label for="ownerFullName">ПІБ Пацієнта
                            <input type="text" id="ownerFullName" name="ownerFullName" class="form-control form-control-lg" required/>
                        </label>
                    </div>
                    <div class="form-outline mb-4">
                        <label for="drugName">Введіть назву лікарських засобів
                            <input type="email" id="drugName" name="drugName" class="form-control form-control-lg" required/>
                        </label>
                    </div>
                    <div class="form-outline mb-4">
                        <label for="drugCount">Спосіб застосування лікарських записів
                            <input type="text" id="drugCount" name="drugCount" class="form-control form-control-lg" required/>
                        </label>
                    </div>

                    <div class="form-outline mb-4">
                        <label for="dateStart">Дата виписки рецепту
                            <input type="text" id="dateStart" name="dateStart" class="form-control form-control-lg" required/>
                        </label>
                    </div>

                    <div class="form-outline mb-4">
                        <label for="dateEnd">Кінцева дата дії рецепта
                            <input type="text" id="dateEnd" name="dateEnd" class="form-control form-control-lg" required/>
                        </label>
                    </div>

                    <div class="form-outline mb-4">
                        <label for="details">Вкажіть деталі щодо рецепту
                            <input type="text" id="details" name="details" class="form-control form-control-lg" required/>
                        </label>
                    </div>
